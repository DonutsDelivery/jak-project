...
// clang-format off
//
// JakX-native mips2c ports of sky-tng asm routines.
//
// Hand-adapted from the jakx MIPS assembly in
// .jakx_watch/decomp_out/jakx/sky-tng_ir2.asm.
//
// Verified structurally identical to jak3 (safe direct ports):
//   - set-tex-offset                            (L124, 23 instr)
//   - render-sky-tri                            (L99, 68 instr)
//   - render-sky-quad                           (L100, 82 instr — minor arg
//                                                convention delta, works
//                                                because callers pass
//                                                math-camera in a2)
//   - draw-large-polygon                        (L121, 115 instr)
//   - clip-polygon-against-positive-hyperplane  (L111, 265 instr)
//   - clip-polygon-against-negative-hyperplane  (L101, 275 instr)
//
// Diverged from jak3 (these bindings are INCORRECT for jakx but registered
// to avoid a null-fn crash; they need proper hand-port from jakx
// sky-tng_ir2.asm):
//   - (method 17 sky-work)   — jakx: 30 instr (init/query-ish);
//                              jak3: 150+ instr (VU matrix setup)
//   - (method 18 sky-work)
//   - (method 29 sky-work)
//   - (method 30 sky-work)
//   - (method 31 sky-work)
//   - (method 32 sky-work)
//   - (method 34 sky-work)   — jakx: DMA buffer / render-sky-tri wrapper;
//                              jak3: 128-vertex VU transform
//   - (method 35 sky-work)
//
// jakx DOES NOT have these functions (jak3-only, left in for link compat):
//   - set-sky-vf27, set-sky-vf23-value
//
...
// Forward declarations — draw-large-polygon calls clip-polygon-against-* which
// are defined later in this file.
namespace Mips2C::jakx {
namespace clip_polygon_against_positive_hyperplane { u64 execute(void* ctxt); }
namespace clip_polygon_against_negative_hyperplane { u64 execute(void* ctxt); }
}  // namespace Mips2C::jakx
...
// using ::jakx::intern_from_c; (already imported at top)
namespace Mips2C::jakx {
