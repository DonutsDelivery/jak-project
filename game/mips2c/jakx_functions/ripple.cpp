...
// JakX-native port of ripple.cpp — four functions (ripple-execute-init,
// ripple-create-wave-table, ripple-apply-wave-table, ripple-matrix-scale).
// Each is structurally identical to jak3's implementation; only the
// namespace was changed. Verified line-for-line against:
//   .jakx_watch/decomp_out/jakx/ripple_ir2.asm
//     L1181 ripple-matrix-scale, L1447 ripple-apply-wave-table,
//     L1537 ripple-create-wave-table, L1851 ripple-execute-init.
// Same stack frames, same symbol loads (*cos-poly-vec*, *display*,
// *fake-scratchpad-data*, *setting-control*, atan/cos/sin,
// ripple-update-waveform-offs, ntsc/pal), same branch structure.
