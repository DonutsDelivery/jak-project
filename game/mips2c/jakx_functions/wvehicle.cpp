...
struct Cache {
  void* find_nearest_camera; // find-nearest-camera
  void* v_wpn_pack_msg; // v-wpn-pack-msg
  void* vector_vector_distance; // vector-vector-distance
  void* vehicle; // vehicle
  void* weapon_acquired; // weapon-acquired
} cache;
...
u64 execute(void* ctxt) {
  ...
  c->mov64(gp, a0);                                 // or gp, a0, r0
  c->load_symbol2(t9, cache.find_nearest_camera);   // lw t9, find-nearest-camera(s7)
  c->lwu(v1, 184, gp);                              // lwu v1, 184(gp)
  c->daddiu(a0, v1, 12);                            // daddiu a0, v1, 12
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mtc1(f0, v0);                                  // mtc1 f0, v0
  c->swc1(f0, 744, gp);                             // swc1 f0, 744(gp)
  c->mfc1(a0, f0);                                  // mfc1 a0, f0

block_2:
  c->lui(v1, -17);                                  // lui v1, -17
  c->ori(v1, v1, 65535);                            // ori v1, v1, 65535
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
  c->lwc1(f0, 744, gp);                             // lwc1 f0, 744(gp)
  c->lui(v1, 18760);                                // lui v1, 18760
  c->mtc1(f1, v1);                                  // mtc1 f1, v1
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = !cop1_bc;                                    // bc1f L207
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_5;}                           // branch non-likely

  c->lui(v1, 16);                                   // lui v1, 16
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->or_(v1, v1, a0);                               // or v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
  c->gprs[v1].du64[0] = UINT64_C(0x0002000000000008); // ld v1, L380(fp)
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L207
  c->mov64(a0, s7);                                 // or a0, s7, r0
  if (bc) {goto block_5;}                           // branch non-likely

  c->daddiu(v1, sp, 16);                            // daddiu v1, sp, 16
  c->lwu(a0, 8, s6);                                // lwu a0, 8(s6)
  c->lwc1(f0, 76, a0);                              // lwc1 f0, 76(a0)
  c->swc1(f0, 48, v1);                              // swc1 f0, 48(v1)
  c->daddiu(a0, v1, 16);                            // daddiu a0, v1, 16
  c->lwu(a1, 192, gp);                              // lwu a1, 192(gp)
  c->daddiu(a1, a1, 204);                           // daddiu a1, a1, 204
  c->lq(a1, 0, a1);                                 // lq a1, 0(a1)
  c->sq(a1, 0, a0);                                 // sq a1, 0(a0)
  ...
  c->lwc1(f3, 48, v1);                              // lwc1 f3, 48(v1)
  c->muls(f2, f2, f3);                              // mul.s f2, f2, f3
  c->adds(f1, f1, f2);                              // add.s f1, f1, f2
  c->maxs(f0, f0, f1);                              // max.s f0, f0, f1
  c->swc1(f0, 16, v1);                              // swc1 f0, 16(v1)
  c->mtc1(f0, r0);                                  // mtc1 f0, r0
  c->lwc1(f1, 20, v1);                              // lwc1 f1, 20(v1)
  c->lui(a0, -16384);                               // lui a0, -16384
  c->mtc1(f2, a0);                                  // mtc1 f2, a0
  c->lwc1(f3, 48, v1);                              // lwc1 f3, 48(v1)
  c->muls(f2, f2, f3);                              // mul.s f2, f2, f3
  ...
  c->adds(f1, f1, f2);                              // add.s f1, f1, f2
  c->maxs(f0, f0, f1);                              // max.s f0, f0, f1
  c->swc1(f0, 24, v1);                              // swc1 f0, 24(v1)
  c->lui(a0, 16256);                                // lui a0, 16256
  c->mtc1(f0, a0);                                  // mtc1 f0, a0
  c->lwc1(f1, 32, v1);                              // lwc1 f1, 32(v1)
  c->lui(a0, 16384);                                // lui a0, 16384
  c->mtc1(f2, a0);                                  // mtc1 f2, a0
  c->lwc1(f3, 48, v1);                              // lwc1 f3, 48(v1)
  c->muls(f2, f2, f3);                              // mul.s f2, f2, f3
  ...
  c->adds(f1, f1, f2);                              // add.s f1, f1, f2
  c->mins(f0, f0, f1);                              // min.s f0, f0, f1
  c->swc1(f0, 36, v1);                              // swc1 f0, 36(v1)
  c->lui(a0, 16256);                                // lui a0, 16256
  c->mtc1(f0, a0);                                  // mtc1 f0, a0
  c->lwc1(f1, 40, v1);                              // lwc1 f1, 40(v1)
  c->lui(a0, 16384);                                // lui a0, 16384
  c->mtc1(f2, a0);                                  // mtc1 f2, a0
  c->lwc1(f3, 48, v1);                              // lwc1 f3, 48(v1)
  c->muls(f2, f2, f3);                              // mul.s f2, f2, f3
  ...
  c->lwu(a0, 192, gp);                              // lwu a0, 192(gp)
  c->daddiu(a0, a0, 204);                           // daddiu a0, a0, 204
  c->daddiu(a1, v1, 16);                            // daddiu a1, v1, 16
  c->lq(a1, 0, a1);                                 // lq a1, 0(a1)
  c->sq(a1, 0, a0);                                 // sq a1, 0(a0)
  c->lwu(a0, 192, gp);                              // lwu a0, 192(gp)
  c->daddiu(a0, a0, 188);                           // daddiu a0, a0, 188
  c->daddiu(v1, v1, 32);                            // daddiu v1, v1, 32
  c->lq(v1, 0, v1);                                 // lq v1, 0(v1)
  c->sq(v1, 0, a0);                                 // sq v1, 0(a0)

block_5:
  c->lui(v1, -97);                                  // lui v1, -97
  c->ori(v1, v1, 65535);                            // ori v1, v1, 65535
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
  c->lwc1(f0, 744, gp);                             // lwc1 f0, 744(gp)
  c->lui(v1, 18544);                                // lui v1, 18544
  c->mtc1(f1, v1);                                  // mtc1 f1, v1
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = cop1_bc;                                     // bc1t L208
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  if (bc) {goto block_7;}                           // branch non-likely
...
block_7:
  if (((s64)c->sgpr64(s7)) != ((s64)c->sgpr64(v1))) {// bnel s7, v1, L209
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_10;
  }
...
block_10:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L210
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_12;}                          // branch non-likely

  c->lui(v1, 96);                                   // lui v1, 96
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->or_(v1, v1, a0);                               // or v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
...
block_12:
  c->lwc1(f0, 744, gp);                             // lwc1 f0, 744(gp)
  c->lui(v1, 18672);                                // lui v1, 18672
  c->mtc1(f1, v1);                                  // mtc1 f1, v1
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = !cop1_bc;                                    // bc1f L211
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_14;}                          // branch non-likely

  c->lui(v1, 64);                                   // lui v1, 64
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->or_(v1, v1, a0);                               // or v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
...
block_14:
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(v1, v0);                                 // or v1, v0, r0
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L212
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_17;
  }
...
block_17:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L228
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_54;}                          // branch non-likely

  c->daddiu(s5, gp, 4580);                          // daddiu s5, gp, 4580
  c->ld(v1, 4508, gp);                              // ld v1, 4508(gp)
  c->subu(a0, v1, s7);                              // subu a0, v1, s7
  if (((s64)c->sgpr64(a0)) == ((s64)0)) {           // beql a0, r0, L214
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_23;
  }
...
block_20:
  ...
  c->lw(a1, 48, a0);                                // lw a1, 48(a0)
  c->dsra32(v1, v1, 0);                             // dsra32 v1, v1, 0
  bc = c->sgpr64(v1) != c->sgpr64(a1);              // bne v1, a1, L213
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_22;}                          // branch non-likely
...
block_23:
  c->ld(a0, 4500, gp);                              // ld a0, 4500(gp)
  c->subu(a1, a0, s7);                              // subu a1, a0, s7
  if (((s64)c->sgpr64(a1)) == ((s64)0)) {           // beql a1, r0, L216
    c->mov64(a0, s7);                               // or a0, s7, r0
    goto block_28;
  }
...
block_25:
  ...
  c->lw(a2, 48, a1);                                // lw a2, 48(a1)
  c->dsra32(a0, a0, 0);                             // dsra32 a0, a0, 0
  bc = c->sgpr64(a0) != c->sgpr64(a2);              // bne a0, a2, L215
  c->mov64(a0, s7);                                 // or a0, s7, r0
  if (bc) {goto block_27;}                          // branch non-likely
...
block_28:
  bc = c->sgpr64(s7) == c->sgpr64(a0);              // beq s7, a0, L217
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_30;}                          // branch non-likely

  c->lbu(s4, 256, a0);                              // lbu s4, 256(a0)
  //beq r0, r0, L218                                // beq r0, r0, L218
  // nop                                            // sll r0, r0, 0
...
block_31:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L219
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_33;}                          // branch non-likely

  c->lbu(s3, 256, v1);                              // lbu s3, 256(v1)
  //beq r0, r0, L220                                // beq r0, r0, L220
  // nop                                            // sll r0, r0, 0
  goto block_34;                                    // branch always
...
block_34:
  bc = c->sgpr64(s7) == c->sgpr64(a0);              // beq s7, a0, L221
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_36;}                          // branch non-likely

  c->lbu(s2, 255, a0);                              // lbu s2, 255(a0)
  //beq r0, r0, L222                                // beq r0, r0, L222
  // nop                                            // sll r0, r0, 0
  goto block_37;                                    // branch always
...
block_37:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L223
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_39;}                          // branch non-likely

  c->lbu(s1, 255, v1);                              // lbu s1, 255(v1)
...
block_40:
  c->lb(v1, 0, s5);                                 // lb v1, 0(s5)
  c->dsubu(v1, v1, s4);                             // dsubu v1, v1, s4
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movn(a0, s7, v1);                              // movn a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L225
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_47;
  }

block_42:
  c->lb(v1, 1, s5);                                 // lb v1, 1(s5)
  c->dsubu(v1, v1, s3);                             // dsubu v1, v1, s3
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movn(a0, s7, v1);                              // movn a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L225
    c->mov64(v1, a0);                               // or v1, a0, r0
...
block_44:
  c->lb(v1, 2, s5);                                 // lb v1, 2(s5)
  c->dsubu(v1, v1, s2);                             // dsubu v1, v1, s2
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movn(a0, s7, v1);                              // movn a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L225
    c->mov64(v1, a0);                               // or v1, a0, r0
...
block_46:
  c->lb(v1, 3, s5);                                 // lb v1, 3(s5)
  c->dsubu(a0, v1, s1);                             // dsubu a0, v1, s1
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  c->movn(v1, s7, a0);                              // movn v1, s7, a0
...
block_47:
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(v1, v0);                                 // or v1, v0, r0
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L226
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_51;
  }
...
block_51:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L227
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_53;}                          // branch non-likely

  c->mov64(a0, gp);                                 // or a0, gp, r0
  c->lwu(v1, -4, a0);                               // lwu v1, -4(a0)
  c->lwu(t9, 124, v1);                              // lwu t9, 124(v1)
  c->load_symbol_addr(a1, cache.weapon_acquired);   // daddiu a1, s7, weapon-acquired
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(s0, v0);                                 // or s0, v0, r0
  c->load_symbol2(t9, cache.v_wpn_pack_msg);        // lw t9, v-wpn-pack-msg(s7)
  c->mov64(a0, gp);                                 // or a0, gp, r0
...
block_53:
  ...
  c->sb(s3, 1, s5);                                 // sb s3, 1(s5)
  c->sb(s2, 2, s5);                                 // sb s2, 2(s5)
  c->sb(s1, 3, s5);                                 // sb s1, 3(s5)
  c->mov64(v1, s1);                                 // or v1, s1, r0

block_54:
  c->mov64(a0, gp);                                 // or a0, gp, r0
  c->lwu(v1, -4, a0);                               // lwu v1, -4(a0)
  c->lwu(t9, 896, v1);                              // lwu t9, 896(v1)
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(v1, v0);                                 // or v1, v0, r0
  c->mov64(a0, gp);                                 // or a0, gp, r0
  c->lwu(v1, -4, a0);                               // lwu v1, -4(a0)
  c->lwu(t9, 904, v1);                              // lwu t9, 904(v1)
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(v1, v0);                                 // or v1, v0, r0
  c->load_symbol2(v1, cache.vehicle);               // lw v1, vehicle(s7)
  c->lwu(t9, 260, v1);                              // lwu t9, 260(v1)
  c->mov64(a0, gp);                                 // or a0, gp, r0
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
...
block_55:
  ...
  c->daddiu(a0, a0, 2476);                          // daddiu a0, a0, 2476
  c->daddu(a0, a0, gp);                             // daddu a0, a0, gp
  c->lbu(a1, 4, a0);                                // lbu a1, 4(a0)
  c->sb(a1, 5, a0);                                 // sb a1, 5(a0)
  c->daddiu(v1, v1, 1);                             // daddiu v1, v1, 1

block_56:
  c->slti(a0, v1, 4);                               // slti a0, v1, 4
  bc = c->sgpr64(a0) != 0;                          // bne a0, r0, L229
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_55;}                          // branch non-likely
...
void link() {
  cache.find_nearest_camera = intern_from_c(-1, 0, "find-nearest-camera").c();
  cache.v_wpn_pack_msg = intern_from_c(-1, 0, "v-wpn-pack-msg").c();
  cache.vector_vector_distance = intern_from_c(-1, 0, "vector-vector-distance").c();
  cache.vehicle = intern_from_c(-1, 0, "vehicle").c();
  cache.weapon_acquired = intern_from_c(-1, 0, "weapon-acquired").c();
  gLinkedFunctionTable.reg("(method 61 wvehicle)", execute, 192);
}
...
u64 execute(void* ctxt) {
  ...
  c->mov64(s5, a1);                                 // or s5, a1, r0
  c->lwu(v1, 8, s6);                                // lwu v1, 8(s6)
  c->lwc1(f30, 76, v1);                             // lwc1 f30, 76(v1)
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 512);                             // andi v1, v1, 512
  ...
  c->lwu(v1, 252, gp);                              // lwu v1, 252(gp)
  c->lwu(a0, 228, gp);                              // lwu a0, 228(gp)
  c->daddiu(a1, a0, 140);                           // daddiu a1, a0, 140
  c->lwu(a0, 228, gp);                              // lwu a0, 228(gp)
  c->daddiu(a0, a0, 204);                           // daddiu a0, a0, 204
  c->lwc1(f0, 0, a1);                               // lwc1 f0, 0(a1)
  c->lwc1(f1, 4, a1);                               // lwc1 f1, 4(a1)
  ...
  c->daddiu(a1, a0, 140);                           // daddiu a1, a0, 140
  c->lwu(a0, 228, gp);                              // lwu a0, 228(gp)
  c->daddiu(a0, a0, 172);                           // daddiu a0, a0, 172
  ...
  c->abss(f1, f1);                                  // abs.s f1, f1
  c->muls(f1, f2, f1);                              // mul.s f1, f2, f1
  c->lui(a0, 17356);                                // lui a0, 17356
  c->ori(a0, a0, 52429);                            // ori a0, a0, 52429
  c->mtc1(f2, a0);                                  // mtc1 f2, a0
  c->maxs(f2, f2, f0);                              // max.s f2, f2, f0
  c->divs(f1, f1, f2);                              // div.s f1, f1, f2
  c->lwc1(f2, 332, v1);                             // lwc1 f2, 332(v1)
  c->lui(a0, 17356);                                // lui a0, 17356
  c->ori(a0, a0, 52429);                            // ori a0, a0, 52429
  c->mtc1(f3, a0);                                  // mtc1 f3, a0
  c->lwc1(f4, 336, v1);                             // lwc1 f4, 336(v1)
  c->subs(f0, f0, f4);                              // sub.s f0, f0, f4
  c->maxs(f0, f3, f0);                              // max.s f0, f3, f0
  c->divs(f0, f2, f0);                              // div.s f0, f2, f0
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 32768);                           // andi v1, v1, 32768
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L148
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_3;}                           // branch non-likely
...
block_3:
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mtc1(f0, v0);                                  // mtc1 f0, v0
  c->swc1(f0, 480, gp);                             // swc1 f0, 480(gp)
  c->gprs[v1].du64[0] = 0;                          // or v1, r0, r0
...
block_5:
  c->load_symbol2(t9, cache.seek);                  // lw t9, seek(s7)
  c->lwc1(f0, 492, gp);                             // lwc1 f0, 492(gp)
  c->mfc1(a0, f0);                                  // mfc1 a0, f0
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mtc1(f0, v0);                                  // mtc1 f0, v0
  c->swc1(f0, 492, gp);                             // swc1 f0, 492(gp)
  c->lwc1(f0, 16, s5);                              // lwc1 f0, 16(s5)
  c->swc1(f0, 496, gp);                             // swc1 f0, 496(gp)
  c->lwc1(f0, 4, s5);                               // lwc1 f0, 4(s5)
  c->lwc1(f28, 8, s5);                              // lwc1 f28, 8(s5)
  c->mtc1(f1, r0);                                  // mtc1 f1, r0
  cop1_bc = c->fprs[f1] < c->fprs[f0];              // c.lt.s f1, f0
  ...
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
  c->lwc1(f1, 2360, gp);                            // lwc1 f1, 2360(gp)
  c->lui(v1, -16448);                               // lui v1, -16448
  c->mtc1(f2, v1);                                  // mtc1 f2, v1
  cop1_bc = c->fprs[f1] < c->fprs[f2];              // c.lt.s f1, f2
  bc = !cop1_bc;                                    // bc1f L151
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_8;}                           // branch non-likely

  c->lui(v1, 16256);                                // lui v1, 16256
  c->mtc1(f28, v1);                                 // mtc1 f28, v1
  c->mfc1(v1, f28);                                 // mfc1 v1, f28
...
block_9:
  c->mtc1(f1, r0);                                  // mtc1 f1, r0
  c->lwc1(f2, 16, s5);                              // lwc1 f2, 16(s5)
  cop1_bc = c->fprs[f1] < c->fprs[f2];              // c.lt.s f1, f2
  bc = !cop1_bc;                                    // bc1f L153
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_11;}                          // branch non-likely
...
block_11:
  c->mtc1(f1, r0);                                  // mtc1 f1, r0
  cop1_bc = c->fprs[f1] < c->fprs[f28];             // c.lt.s f1, f28
  bc = !cop1_bc;                                    // bc1f L156
  // nop                                            // sll r0, r0, 0
  ...
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L154
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_14;}                          // branch non-likely

  c->movs(f0, f28);                                 // mov.s f0, f28
  c->mtc1(f28, r0);                                 // mtc1 f28, r0
  c->mfc1(v1, f28);                                 // mfc1 v1, f28
  //beq r0, r0, L155                                // beq r0, r0, L155
  // nop                                            // sll r0, r0, 0
  goto block_16;                                    // branch always
...
block_14:
  ...
  c->daddu(a0, r0, v1);                             // daddu a0, r0, v1
  c->lwu(a1, 228, gp);                              // lwu a1, 228(gp)
  c->daddiu(a1, a1, 140);                           // daddiu a1, a1, 140
  c->daddiu(a2, gp, 3644);                          // daddiu a2, gp, 3644
  ...
  c->mfc1(v1, f1);                                  // mfc1 v1, f1
  c->mtc1(f1, v1);                                  // mtc1 f1, v1
  c->lui(v1, 18208);                                // lui v1, 18208
  c->mtc1(f2, v1);                                  // mtc1 f2, v1
  cop1_bc = c->fprs[f1] < c->fprs[f2];              // c.lt.s f1, f2
  bc = !cop1_bc;                                    // bc1f L155
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_16;}                          // branch non-likely
...
block_18:
  ...
  c->daddiu(a1, s7, 4);                             // daddiu a1, s7, 4
  c->movn(a1, s7, a0);                              // movn a1, s7, a0
  if (((s64)c->sgpr64(s7)) != ((s64)c->sgpr64(a1))) {// bnel s7, a1, L158
    c->mov64(v1, a1);                               // or v1, a1, r0
    goto block_21;
  }
...
block_21:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L159
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_23;}                          // branch non-likely
...
block_23:
  c->load_symbol2(t9, cache.seek);                  // lw t9, seek(s7)
  c->lwc1(f1, 484, gp);                             // lwc1 f1, 484(gp)
  c->mfc1(a0, f1);                                  // mfc1 a0, f1
  c->mfc1(a1, f0);                                  // mfc1 a1, f0
  c->lui(v1, 16640);                                // lui v1, 16640
  c->mtc1(f0, v1);                                  // mtc1 f0, v1
  ...
  c->jalr(call_addr);                               // jalr ra, t9
  c->mtc1(f0, v0);                                  // mtc1 f0, v0
  c->swc1(f0, 484, gp);                             // swc1 f0, 484(gp)
  c->lwc1(f0, 488, gp);                             // lwc1 f0, 488(gp)
  c->lwc1(f1, 488, gp);                             // lwc1 f1, 488(gp)
  c->subs(f1, f28, f1);                             // sub.s f1, f28, f1
  c->lui(v1, 16256);                                // lui v1, 16256
  c->mtc1(f2, v1);                                  // mtc1 f2, v1
  c->lui(v1, 16640);                                // lui v1, 16640
  c->mtc1(f3, v1);                                  // mtc1 f3, v1
  c->muls(f3, f3, f30);                             // mul.s f3, f3, f30
  c->mins(f2, f2, f3);                              // min.s f2, f2, f3
  c->muls(f1, f1, f2);                              // mul.s f1, f1, f2
  c->adds(f0, f0, f1);                              // add.s f0, f0, f1
  c->swc1(f0, 488, gp);                             // swc1 f0, 488(gp)
  c->mfc1(v1, f0);                                  // mfc1 v1, f0
  c->lbu(v1, 500, gp);                              // lbu v1, 500(gp)
  c->sb(v1, 501, gp);                               // sb v1, 501(gp)
  c->lbu(v1, 20, s5);                               // lbu v1, 20(s5)
  c->sb(v1, 500, gp);                               // sb v1, 500(gp)
  c->gprs[v0].du64[0] = 0;                          // or v0, r0, r0
  c->ld(ra, 0, sp);                                 // ld ra, 0(sp)
...
void link() {
  cache.seek = intern_from_c(-1, 0, "seek").c();
  gLinkedFunctionTable.reg("(method 133 wvehicle)", execute, 80);
}

} // namespace method_133_wvehicle

namespace method_112_wvehicle {
struct Cache {
  void* enter_state; // enter-state
  void* vehicle; // vehicle
  void* wv_player_post_move_update; // wv-player-post-move-update
} cache;
...
u64 execute(void* ctxt) {
  ...
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 1024);                            // andi v1, v1, 1024
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L234
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_2;}                           // branch non-likely

  c->load_symbol2(t9, cache.wv_player_post_move_update);// lw t9, wv-player-post-move-update(s7)
  c->mov64(a0, gp);                                 // or a0, gp, r0
  c->lwu(a1, 0, s5);                                // lwu a1, 0(s5)
  c->lwc1(f0, 4, s5);                               // lwc1 f0, 4(s5)
  c->mfc1(a2, f0);                                  // mfc1 a2, f0
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
...
block_2:
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 32);                              // andi v1, v1, 32
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L236
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_7;}                           // branch non-likely

  c->ld(v1, 460, gp);                               // ld v1, 460(gp)
  c->andi(v1, v1, 32);                              // andi v1, v1, 32
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L235
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_6;}                           // branch non-likely
  ...
  c->lui(v1, 16256);                                // lui v1, 16256
  c->mtc1(f0, v1);                                  // mtc1 f0, v1
  c->lwc1(f2, 700, gp);                             // lwc1 f2, 700(gp)
  c->lui(v1, 16128);                                // lui v1, 16128
  c->mtc1(f3, v1);                                  // mtc1 f3, v1
  c->muls(f1, f3, f1);                              // mul.s f1, f3, f1
  c->adds(f1, f2, f1);                              // add.s f1, f2, f1
  c->mins(f0, f0, f1);                              // min.s f0, f0, f1
  c->swc1(f0, 700, gp);                             // swc1 f0, 700(gp)
  c->mfc1(v1, f0);                                  // mfc1 v1, f0
...
block_6:
  c->lwu(v1, 0, s5);                                // lwu v1, 0(s5)
  c->sw(v1, 796, gp);                               // sw v1, 796(gp)

block_7:
  c->lwu(v1, 228, gp);                              // lwu v1, 228(gp)
  c->lhu(v1, 0, v1);                                // lhu v1, 0(v1)
  c->andi(v1, v1, 256);                             // andi v1, v1, 256
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L237
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_9;}                           // branch non-likely
...
block_9:
  ...
  c->lhu(v1, 0, v1);                                // lhu v1, 0(v1)
  c->andi(v1, v1, 2);                               // andi v1, v1, 2
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L238
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_11;}                          // branch non-likely
...
block_11:
  c->lwu(s4, 228, gp);                              // lwu s4, 228(gp)
  c->lui(v1, 1024);                                 // lui v1, 1024
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L241
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_19;}                          // branch non-likely

  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 64);                              // andi v1, v1, 64
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L239
    c->daddiu(v1, s7, 4);                           // daddiu v1, s7, 4
    goto block_16;
  }
  ...
  c->lui(v1, 16128);                                // lui v1, 16128
  c->mtc1(f0, v1);                                  // mtc1 f0, v1
  c->lwc1(f1, 192, s4);                             // lwc1 f1, 192(s4)
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = cop1_bc;                                     // bc1t L239
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  if (bc) {goto block_16;}                          // branch non-likely
...
block_16:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L240
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_18;}                          // branch non-likely

  c->lui(v1, -1025);                                // lui v1, -1025
  c->ori(v1, v1, 65535);                            // ori v1, v1, 65535
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  c->sd(v1, 260, gp);                               // sd v1, 260(gp)
...
block_18:
  goto block_35;                                    // branch always


block_19:
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 64);                              // andi v1, v1, 64
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L244
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_33;
  }
  ...
  c->lwc1(f0, 192, s4);                             // lwc1 f0, 192(s4)
  c->lui(v1, 16102);                                // lui v1, 16102
  c->ori(v1, v1, 26214);                            // ori v1, v1, 26214
  c->mtc1(f1, v1);                                  // mtc1 f1, v1
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = cop1_bc;                                     // bc1t L242
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  if (bc) {goto block_25;}                          // branch non-likely
...
block_25:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L244
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_33;
  }

  c->daddiu(v1, s4, 140);                           // daddiu v1, s4, 140
  c->lui(a0, 18048);                                // lui a0, 18048
  c->mtc1(f1, a0);                                  // mtc1 f1, a0
  c->lqc2(vf1, 0, v1);                              // lqc2 vf1, 0(v1)
...
block_29:
  ...
  c->daddiu(v1, s4, 156);                           // daddiu v1, s4, 156
  c->lui(a0, 16512);                                // lui a0, 16512
  c->mtc1(f1, a0);                                  // mtc1 f1, a0
  c->lqc2(vf1, 0, v1);                              // lqc2 vf1, 0(v1)
  c->vadd_bc(DEST::x, BC::w, vf2, vf0, vf0);        // vaddw.x vf2, vf0, vf0
...
block_33:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L245
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_35;}                          // branch non-likely
  ...
  c->lwu(v1, 8, s6);                                // lwu v1, 8(s6)
  c->ld(v1, 20, v1);                                // ld v1, 20(v1)
  c->sw(v1, 3884, gp);                              // sw v1, 3884(gp)

block_35:
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 8);                               // andi v1, v1, 8
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L255
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_74;}                          // branch non-likely

  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 32768);                           // andi v1, v1, 32768
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L248
    c->daddiu(v1, s7, 4);                           // daddiu v1, s7, 4
    goto block_54;
  }

  c->lwu(v1, 0, s5);                                // lwu v1, 0(s5)
  c->lwu(a0, 784, gp);                              // lwu a0, 784(gp)
  c->dsubu(v1, v1, a0);                             // dsubu v1, v1, a0
  c->sltu(v1, r0, v1);                              // sltu v1, r0, v1
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movz(a0, s7, v1);                              // movz a0, s7, v1
  if (((s64)c->sgpr64(s7)) != ((s64)c->sgpr64(a0))) {// bnel s7, a0, L248
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_54;
  }

  c->lhu(v1, 0, s4);                                // lhu v1, 0(s4)
  c->andi(v1, v1, 512);                             // andi v1, v1, 512
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L247
    c->daddiu(v1, s7, 4);                           // daddiu v1, s7, 4
    goto block_52;
  }

  c->lbu(v1, 3056, gp);                             // lbu v1, 3056(gp)
  c->andi(v1, v1, 2);                               // andi v1, v1, 2
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L247
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_52;
  ...
  c->lbu(v1, 3344, gp);                             // lbu v1, 3344(gp)
  c->andi(v1, v1, 2);                               // andi v1, v1, 2
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L247
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_52;
...
block_48:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L247
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_52;
  }
...
block_52:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L248
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  if (bc) {goto block_54;}                          // branch non-likely
...
block_54:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L249
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_56;}                          // branch non-likely

  c->lwu(v1, 0, s5);                                // lwu v1, 0(s5)
  c->sw(v1, 836, gp);                               // sw v1, 836(gp)
  c->gprs[v1].du64[0] = 0;                          // or v1, r0, r0
...
block_56:
  ...
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  if (((s64)c->sgpr64(v1)) == ((s64)0)) {           // beql v1, r0, L251
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_66;
  }
...
block_60:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L251
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_66;
  }
  ...
  c->lwu(a0, 784, gp);                              // lwu a0, 784(gp)
  c->dsubu(v1, v1, a0);                             // dsubu v1, v1, a0
  c->sltiu(v1, v1, 15);                             // sltiu v1, v1, 15
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movz(a0, s7, v1);                              // movz a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L251
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_66;
  }
...
block_66:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L252
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_68;}                          // branch non-likely

  // stub: format(#t, L377)  -- elided debug print, L377 string-label load
  c->load_symbol2(t9, cache.enter_state);           // lw t9, enter-state(s7)
  c->lwu(v1, -4, gp);                               // lwu v1, -4(gp)
  c->lwu(v1, 400, v1);                              // lwu v1, 400(v1)
...
block_68:
  c->daddiu(v1, s4, 44);                            // daddiu v1, s4, 44
  c->lui(a0, 19584);                                // lui a0, 19584
  c->mtc1(f0, a0);                                  // mtc1 f0, a0
  c->muls(f0, f0, f0);                              // mul.s f0, f0, f0
  c->mfc1(a0, f0);                                  // mfc1 a0, f0
  c->mtc1(f0, a0);                                  // mtc1 f0, a0
...
block_70:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L254
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_72;}                          // branch non-likely

  // stub: format(#t, L376, sqrt-mag-of-(s4+44))  -- elided debug print, L376 string-label load
  c->load_symbol2(t9, cache.enter_state);           // lw t9, enter-state(s7)
  c->lwu(v1, -4, gp);                               // lwu v1, -4(gp)
  c->lwu(v1, 400, v1);                              // lwu v1, 400(v1)
  c->sw(v1, 76, s6);                                // sw v1, 76(s6)
...
block_72:
  c->addiu(v1, r0, 900);                            // addiu v1, r0, 900
  c->lwu(a0, 0, s5);                                // lwu a0, 0(s5)
  c->lwu(a1, 836, gp);                              // lwu a1, 836(gp)
  c->dsubu(a0, a0, a1);                             // dsubu a0, a0, a1
  c->sltu(v1, v1, a0);                              // sltu v1, v1, a0
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L255
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_74;}                          // branch non-likely

  // stub: format(#t, L375)  -- elided debug print, L375 string-label load
  c->load_symbol2(t9, cache.enter_state);           // lw t9, enter-state(s7)
  c->lwu(v1, -4, gp);                               // lwu v1, -4(gp)
  c->lwu(v1, 400, v1);                              // lwu v1, 400(v1)
  c->sw(v1, 76, s6);                                // sw v1, 76(s6)
...
block_74:
  c->gprs[v1].du64[0] = UINT64_C(0x0000010000000800);// ld v1, L382(fp) — constant pool .word 0x800,0x10000
  c->ld(a0, 260, gp);                               // ld a0, 260(gp)
  c->and_(v1, v1, a0);                              // and v1, v1, a0
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L257
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_85;
  }

  c->lwu(v1, 528, gp);                              // lwu v1, 528(gp)
  c->andi(v1, v1, 5);                               // andi v1, v1, 5
  if (((s64)c->sgpr64(v1)) != ((s64)0)) {           // bnel v1, r0, L257
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_85;
  }
  ...
  c->ld(v1, 260, gp);                               // ld v1, 260(gp)
  c->andi(v1, v1, 4096);                            // andi v1, v1, 4096
  if (((s64)c->sgpr64(v1)) == ((s64)0)) {           // beql v1, r0, L256
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_81;
  }
  ...
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  c->lwu(a0, 228, gp);                              // lwu a0, 228(gp)
  c->lhu(a0, 0, a0);                                // lhu a0, 0(a0)
  c->andi(a0, a0, 2);                               // andi a0, a0, 2
  c->movn(v1, s7, a0);                              // movn v1, s7, a0

block_81:
  if (((s64)c->sgpr64(s7)) != ((s64)c->sgpr64(v1))) {// bnel s7, v1, L257
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_85;
  }
  ...
  c->lwc1(f1, 48, s4);                              // lwc1 f1, 48(s4)
  c->adds(f0, f0, f1);                              // add.s f0, f0, f1
  c->lwc1(f1, 852, gp);                             // lwc1 f1, 852(gp)
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  bc = cop1_bc;                                     // bc1t L257
  c->daddiu(v1, s7, 4);                             // daddiu v1, s7, 4
  if (bc) {goto block_85;}                          // branch non-likely
...
block_85:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L258
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_87;}                          // branch non-likely

  c->load_symbol2(t9, cache.enter_state);           // lw t9, enter-state(s7)
  c->lwu(v1, -4, gp);                               // lwu v1, -4(gp)
  c->lwu(v1, 852, v1);                              // lwu v1, 852(v1)
  c->sw(v1, 76, s6);                                // sw v1, 76(s6)
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
...
void link() {
  ...
  cache.vehicle = intern_from_c(-1, 0, "vehicle").c();
  cache.wv_player_post_move_update = intern_from_c(-1, 0, "wv-player-post-move-update").c();
  gLinkedFunctionTable.reg("(method 112 wvehicle)", execute, 80);
}
