...
// adgif-shader<-texture-with-update! — verbatim copy-port from jak3.
//
// No interns (function is self-contained). Present in jakx namespace for
// consistency and to isolate from jak3's copy should binary divergence
// surface later.
//
// Source: game/mips2c/jak3_functions/texture.cpp
